        ...
        <form id="editUserForm">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="brand" class="form-control" id="brand" name="brand" required>
            </div>
...
<script src="<?= base_url('js/phone/phone.js') ?>"></script>
<?= $this->endSection() ?>
